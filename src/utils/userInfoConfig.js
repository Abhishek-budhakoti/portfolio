...
const userInfo = {
    about: {
        ...
        aboutMe: `My name is ${Lang.name},I am from yammun nagar,Haryan and my belongings are from garhwal(uttrakhand) 
         A passionate and self-driven web developer with a strong foundation in HTML, CSS, JavaScript, and modern frameworks like React.js. I enjoy transforming ideas into interactive and visually appealing web experiences. While I may be new to the industry, I’m constantly learning and building projects that challenge and grow my skills. I’m excited to collaborate, contribute, and grow in real-world development environments.
         `,
    },
    social: {
 ...
 projects: [
  ...
  },
  {
    ...
    link: 'https://pokedexapi23.netlify.app/', 
    alter: 'pokedex',
    image: './photo.jpg',
  },
  {
